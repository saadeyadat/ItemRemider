...
class NewParticipantFragment(
    private val list: Lists,
    private val allUsersStr: MutableList<String>,
    private val allUsersList: MutableList<User>
): Fragment(R.layout.new_participant_fragment) {
